...
# while (True):
#     cap = cv2.VideoCapture("dados-video.mp4") #video_name is the video being called
#     cap.set(1,count); # Where frame_no is the frame you want
...
while (True):
    cap = cv2.VideoCapture("dados-video.mp4")
    cap.set(1,count); 
    ret, frame = cap.read() 
